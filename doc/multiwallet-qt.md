...
In order to support loading of multiple wallets in krt-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is krt.cpp.
...
Changes to krt.cpp
----------------------
krt.cpp is the entry point into krt-qt, and as such, will require some minor modifications to provide hooks for
