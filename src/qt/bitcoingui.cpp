                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("KRT Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a KRT address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and krt: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About KRT Core"), this);
    aboutAction->setStatusTip(tr("Show information about KRT Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for KRT"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your KRT addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified KRT addresses"));
    ...
    openAction->setStatusTip(tr("Open a KRT: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the KRT Core help message to get a list with possible KRT command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("KRT Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to KRT network", "", count));
}
...
{
    QString strTitle = tr("KRT Core"); // default title
