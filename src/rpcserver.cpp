...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Krt features */
        {"krt", "masternode", &masternode, true, true, false},
        {"krt", "listmasternodes", &listmasternodes, true, true, false},
        {"krt", "getmasternodecount", &getmasternodecount, true, true, false},
        {"krt", "masternodeconnect", &masternodeconnect, true, true, false},
        {"krt", "masternodecurrent", &masternodecurrent, true, true, false},
        {"krt", "masternodedebug", &masternodedebug, true, true, false},
        {"krt", "startmasternode", &startmasternode, true, true, false},
        {"krt", "createmasternodekey", &createmasternodekey, true, true, false},
        {"krt", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"krt", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"krt", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"krt", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"krt", "getmasternodescores", &getmasternodescores, true, true, false},
        {"krt", "mnbudget", &mnbudget, true, true, false},
        {"krt", "preparebudget", &preparebudget, true, true, false},
        {"krt", "submitbudget", &submitbudget, true, true, false},
        {"krt", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"krt", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"krt", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"krt", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"krt", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"krt", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"krt", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"krt", "checkbudgets", &checkbudgets, true, true, false},
        {"krt", "mnsync", &mnsync, true, true, false},
        {"krt", "spork", &spork, true, true, false},
        {"krt", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"krt", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use krtd, or the -server option to krt-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> krt-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:47042/\n";
}
