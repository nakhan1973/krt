...
#if defined(NDEBUG)
#error "KRT cannot be compiled without assertions."
#endif
...
int64_t GetBlockValue(int nHeight)
{
    ...
    if (nHeight == 0) {
        nSubsidy = 6307200 * COIN;
    } else if (nHeight < Params().LAST_POW_BLOCK()  && nHeight > 0) {
		nSubsidy = 1 * COIN;
    } else if (nHeight < 3840 && nHeight >= Params().LAST_POW_BLOCK()) {
        nSubsidy = 1 * COIN;
    } else if (nHeight < 5760  && nHeight >= 3840) {
        nSubsidy = 150 * COIN;
    } else if (nHeight < 13440 && nHeight >= 5760) {
        nSubsidy = 175 * COIN;
    } else if (nHeight < 17280 && nHeight >= 13440) {
        nSubsidy = 200 * COIN;
    } else if (nHeight < 21120 && nHeight >= 17280) {
        nSubsidy = 225 * COIN;
    } else if (nHeight < 24960 && nHeight >= 21120) {
        nSubsidy = 250 * COIN;
    } else if (nHeight < 28800  && nHeight >= 24960) {
        nSubsidy = 275 * COIN;
    } else if (nHeight < 86400  && nHeight >= 28800) {
        nSubsidy = 300 * COIN;
    } else if (nHeight < 115200  && nHeight >= 86400) {
        nSubsidy = 250 * COIN;
    } else if (nHeight < 144000  && nHeight >= 115200) {
        nSubsidy = 200 * COIN;
    } else if (nHeight < 172800  && nHeight >= 144000) {
        nSubsidy = 150 * COIN;
    } else if (nHeight < 201600  && nHeight >= 172800) {
        nSubsidy = 100 * COIN;
