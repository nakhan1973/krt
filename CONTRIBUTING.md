Contributing to KRT Core
============================

The KRT Core project operates an open contributor model where anyone is
...
The following applies to code changes to the KRT Core project, and is not to be
confused with overall KRT Network Protocol consensus changes.

Whether a pull request is merged into KRT Core rests with the project merge
...
Patches that change KRT consensus rules are considerably more involved than
...
Where a patch set proposes to change the KRT consensus, it must have been
...
The project leader is the release manager for each KRT Core release.
