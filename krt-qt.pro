...
RESOURCES += src/qt/krt.qrc src/qt/krt_locale.qrc

TRANSLATIONS += src/qt/locale/krt_bg.ts \
                src/qt/locale/krt_de.ts \
                src/qt/locale/krt_en.ts \
                src/qt/locale/krt_es.ts \
                src/qt/locale/krt_fi.ts \
                src/qt/locale/krt_fr.ts \
                src/qt/locale/krt_it.ts \
                src/qt/locale/krt_ja.ts \
                src/qt/locale/krt_pl.ts \
                src/qt/locale/krt_pt.ts \
                src/qt/locale/krt_ru.ts \
                src/qt/locale/krt_sk.ts \
                src/qt/locale/krt_sv.ts \
                src/qt/locale/krt_vi.ts \
                src/qt/locale/krt_zh_CN.ts \
                src/qt/locale/krt_zh_TW.ts
